...
import { updateOrderStage, cancelOrder, updateOrderTime } from '../redux/actions';
import '../css/PizzaTracker.css';
            ...
            {orders
              ...
              .map((order) => (
                ...
                >
                  ...
                  <p>Time in current stage: {order.time - (order.prevTime || 0)} sec</p>
