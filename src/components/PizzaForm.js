    ...
    <div className="form-container">
      ...
      <form>
         <label className="label">
          Pizza Type:
          <select className="select" name="type" value={order.type} onChange={handleInputChange}>
        ...
        <label className="label">
          Pizza Size:
          <select className="select" name="size" value={order.size} onChange={handleInputChange}>
        ...
        <label className="label">
          Pizza Base:
          <select className="select" name="base" value={order.base} onChange={handleInputChange}>
